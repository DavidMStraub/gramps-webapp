...
</dom-module>`));document.head.appendChild(i.content);const n=a(t||(t=o`<dom-module id="material-checkbox" theme-for="vaadin-checkbox">
  <template>
    <style>
      :host {
        display: inline-block;
